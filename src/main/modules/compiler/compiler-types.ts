...
const BoardInfoSchema = z.object({
  compiler: z.enum(['arduino-cli', 'openplc-compiler', 'emscripten']),
  core: z.string().optional(),
  default_ain: z.string().optional(),
  default_aout: z.string().optional(),
  default_din: z.string().optional(),
  default_dout: z.string().optional(),
