      ...
      pous: [
        {
          ...
          documentation: {
            content: "Initialize P1AM Modules and return the number of initialized modules on SUCCESS. If SUCCESS is zero, an error has occurred, or there aren't any modules on the bus",
          },
        },
        {
          name: "P1_16CDR",
          ...
          documentation: {
            content: "Get all inputs and update all outputs from P1-16CDR module. Also works with P1-15CDD1 and P1-15CDD2",
          },
        },
        {
          name: "P1_08N",
