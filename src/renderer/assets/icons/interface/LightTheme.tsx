...
type ILightThemeProps = ComponentProps<"svg"> & {
  size?: "sm" | "md" | "lg";
};
const sizeClasses = {
  sm: "w-7 h-7",
...
export const LightThemeIcon = (props: ILightThemeProps) => {
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_1910_2557"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_1910_2557"
            result="effect2_dropShadow_1910_2557"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_1910_2557"
            result="shape"
          />
        </filter>
