...
export const PlaceholderNode = ({ pathClassName }: PlaceholderSVGType) => {
  return (
...
export const PlaceholderNodeFilled = ({ pathClassName }: PlaceholderSVGType) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' className={pathClassName} fill='currentColor' viewBox='0 0 16 16'>
      <path
        fillRule='evenodd'
        className={pathClassName}
