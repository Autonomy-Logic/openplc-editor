...
export const DefaultContact = ({ strokeClassName, width, height }: ContactSVGType) => {
  return (
    ...
    >
      <line x1='26.75' x2='26.75' y2='28' stroke='#030303' className={strokeClassName} strokeWidth='1.5' />
      <line x1='0.75' x2='0.75' y2='28' stroke='#030303' className={strokeClassName} strokeWidth='1.5' />
    </svg>
  )
}
