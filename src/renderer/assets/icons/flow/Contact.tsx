...
export const RisingEdgeContact = ({ strokeClassName, strokeColor, width, height }: ContactSVGType) => {
  return (
    <svg
      width={width ?? '28'}
      height={height ?? '28'}
...
export const FallingEdgeContact = ({ strokeClassName, strokeColor, width, height }: ContactSVGType) => {
  return (
    <svg
      width={width ?? '28'}
      height={height ?? '28'}
