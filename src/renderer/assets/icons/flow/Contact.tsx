...
export const DefaultContact = ({ className, width, height }: ContactSVGType) => {
  return (
    <svg
      width={width ?? '28'}
      height={height ?? '28'}
    ...
    >
      <line x1='26.75' x2='26.75' y2='28' stroke='#030303' className={className} stroke-width='1.5' />
      <line x1='0.75' x2='0.75' y2='28' stroke='#030303' className={className} stroke-width='1.5' />
    </svg>
  )
}

export const NegatedContact = ({ className, width, height }: ContactSVGType) => {
  return (
    <svg
      width={width ?? '28'}
      height={height ?? '28'}
...
export const RisingEdgeContact = ({ className, width, height }: ContactSVGType) => {
  return (
    <svg
      width={width ?? '28'}
      height={height ?? '28'}
...
export const FallingEdgeContact = ({ className, width, height }: ContactSVGType) => {
  return (
    <svg
      width={width ?? '28'}
      height={height ?? '28'}
