...
export const DefaultContact = ({ width, height }: ContactSVGType) => {
  return (
    <svg
      width={width ?? '28'}
      height={height ?? '28'}
...
export const NegatedContact = ({ width, height }: ContactSVGType) => {
  return (
    <svg
      width={width ?? '28'}
      height={height ?? '28'}
...
export const RisingEdgeContact = ({ width, height }: ContactSVGType) => {
  return (
    <svg
      width={width ?? '28'}
      height={height ?? '28'}
...
export const FallingEdgeContact = ({ width, height }: ContactSVGType) => {
  return (
    <svg
      width={width ?? '28'}
      height={height ?? '28'}
