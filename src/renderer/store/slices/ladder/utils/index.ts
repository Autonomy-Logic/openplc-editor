...
/**
 * Checks if a function block variable is still in use by any block in the ladder flows.
 ...
 * @param allRungs - All rungs in the ladder flow
 * @returns true if the variable is still in use, false otherwise
 */
export const isFunctionBlockVariableInUse = (variableName: string, allRungs: RungLadderState[]): boolean => {
