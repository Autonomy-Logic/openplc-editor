...
export default function ActionsBar() {
	...
	return (
		<div className='w-full  pr-10 xl:pr-7 xxl:pr-10 flex mb-4 items-center justify-between relative'>
			...
			<Search.Root className='flex w-[704px] border-neutral-100 border-[1.5px] gap-4 px-8 rounded-lg text-base font-caption items-center h-14 bg-white dark:bg-neutral-50'>
				<StartSearchIcon />
				<Search.Input
