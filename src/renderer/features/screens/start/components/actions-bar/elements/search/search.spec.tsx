...
describe('Input Component', () => {
  it('renders with className and placeholder', () => {
    const { container } = render(<Search.Input className='custom-class' placeholder='Enter text' />)
  ...
  it('renders with additional props', () => {
    ...
    expect(container.querySelector('input')).toHaveAttribute('data-testid', 'test-id')
  })
})
