...
export const Header = (props: IHeaderProps): ReactNode => {
  ...
  return (
    <div className='my-3 flex w-full justify-normal gap-2 px-2 '>
      <div className='flex h-8 w-full flex-1 cursor-default select-none items-center justify-start gap-2 rounded-lg bg-neutral-100 px-1.5 dark:bg-brand-dark'>
        <TitleIcon />
