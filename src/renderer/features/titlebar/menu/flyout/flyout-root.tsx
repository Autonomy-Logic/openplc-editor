...
export const FlyoutMenuRoot = (props: IFlyoutMenuRootProps) => {
  ...
  return (
    <Menubar.Root>
      <Menubar.Menu>
        <Menubar.Trigger className="w-fit h-fit px-2 py-px text-white font-caption font-light text-xs rounded-sm bg-brand-dark dark:bg-neutral-950  hover:bg-brand-medium-dark hover:shadow-2xl hover:dark:bg-neutral-900 transition-colors">
          {label}
        </Menubar.Trigger>
