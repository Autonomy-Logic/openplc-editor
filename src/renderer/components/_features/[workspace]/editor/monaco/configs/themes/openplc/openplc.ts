...
const lightThemeData: monaco.editor.IStandaloneThemeData = {
  ...
  rules: [
    ...
    { token: 'variable', foreground: '#000000' }, // Black for keywords in ST language in dark theme
  ],
  colors: {
...
const darkThemeData: monaco.editor.IStandaloneThemeData = {
  ...
  rules: [
    ...
    { token: 'variable', foreground: '#FFFFFF' }, // White for keywords in ST language in dark theme
  ],
  colors: {
