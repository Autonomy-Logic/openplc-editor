    ...
    <Modal open={isOpen} onOpenChange={onClose}>
      <ModalContent onClose={onClose} className='h-[400px]'>
        ...
        {step === 1 ? (
          ...
          <div className='flex h-full w-full flex-col items-center justify-around'>
            <div className='relative mb-8 flex h-[100px] items-center justify-center'>
              <div className='z-10 flex h-12 w-12 items-center justify-center rounded-full border-2 border-blue-200 bg-blue-300 font-bold text-white'>
                1
              </div>
            ...
            <div>
              <h2 className='mb-2 text-center text-lg font-semibold text-neutral-1000'>Give a name for the project:</h2>
              <div className='h-[28px] w-[260px] flex justify-start '>
                  <input
                    id='project-name'
                    className={` box-border h-full w-full cursor-text rounded-lg border-2 border-blue-500 bg-transparent px-2 py-0 text-xs font-medium leading-tight text-neutral-1000 outline-none dark:text-neutral-50`}
                    value={projectName}
            ...
            <div>
              <h2 className='text-center text-lg font-semibold text-neutral-1000'>
