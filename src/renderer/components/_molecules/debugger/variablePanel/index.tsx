...
export default function VariablePanel() {
  return (
    <div className='flex h-auto w-[20%] flex-col gap-2 overflow-auto rounded-lg border-[0.75px] border-neutral-200 bg-white p-2 text-cp-base font-medium text-neutral-1000 dark:text-neutral-50'>
      <div className='flex h-7 w-[90px] items-center gap-1 rounded-lg bg-neutral-100 p-1'>
