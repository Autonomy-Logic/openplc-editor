...
describe('Root Component', () => {
  ...
  test('passes HTMLAttributes to the component', () => {
    ...
    const { getByTestId } = render(<Card.Root data-testid='root-test-id' data-custom-prop={customProp} />)
...
describe('Label Component', () => {
  ...
  test('renders correctly', () => {
    ...
    const { container } = render(<Card.Label title='Test title' description='Test description' />)
    // Compare the rendered container with a snapshot
    expect(container).toMatchSnapshot()
  })
...
describe('Preview Component', () => {
  ...
  test('passes HTMLAttributes to the component', () => {
    ...
    const { getByTestId } = render(
      <Card.Preview data-testid='preview-test-id' data-custom-prop={customProp} source='Test source' />,
    )
