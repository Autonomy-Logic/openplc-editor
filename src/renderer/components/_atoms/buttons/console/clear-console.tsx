...
const ClearConsoleButton = () => {
  ...
  return (
    <button
      type='button'
      className={cn(
        'absolute right-2 top-1 flex h-7 w-fit select-none items-center gap-1 rounded-lg bg-neutral-100 px-2 hover:bg-neutral-200 dark:bg-neutral-850 dark:hover:bg-neutral-900',
