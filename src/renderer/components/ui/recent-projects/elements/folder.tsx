export default function Folder() {
  return (
    <svg width='224' height='160' viewBox='0 0 224 160' xmlns='http://www.w3.org/2000/svg'>
      <path
        id='folder-shape'
        className='fill-blue-700 hover:fill-blue-600 hover:cursor-pointer group-hover/folder-label:fill-blue-600'
      ...
      />
      <text className='fill-white cursor-pointer group/folder-label'>
