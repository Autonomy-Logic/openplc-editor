...
describe('ladderToXml (codesys)', () => {
  ...
  it('converts a contact with default variant', () => {
    ...
    const rung = makeRung({
      nodes: [leftRail as any, contact as any],
  ...
  it('skips unknown node types', () => {
    const rung = makeRung({
      nodes: [
        makeLeftRail() as any,
        { id: 'u1', type: 'placeholder', position: { x: 0, y: 0 }, data: {} } as any,
      ],
    })
    const result = ladderToXml([rung])
  ...
  it('accumulates offsetY across rungs', () => {
    ...
    const rung2 = makeRung({
      ...
      nodes: [
        { ...makeLeftRail('lr2', '101'), position: { x: 0, y: 0 } } as any,
        contact2 as any,
      ],
    })
    const result = ladderToXml([rung1, rung2])
  ...
  it('converts a block node', () => {
    ...
    const rung = makeRung({
      nodes: [leftRail as any, blockNode as any],
  ...
  it('block input handle connects to variable node', () => {
    ...
    const in1 = blockXml.inputVariables.variable.find((v: any) => v['@formalParameter'] === 'IN1')
  ...
  it('contact connected to block uses formalParameter from block variant', () => {
    ...
    const contact = makeContact('c1', '10')
    const rung = makeRung({
      nodes: [leftRail as any, blockNode as any, contact as any],
  ...
  describe('findConnections with parallel nodes', () => {
    it('handles close parallel node connections', () => {
      ...
      const coil = makeCoil('cl1', '20')
      const rung = makeRung({
        nodes: [leftRail as any, contact1 as any, contact2 as any, parallelClose as any, coil as any],
        edges: [
    ...
    it('handles open parallel node connections (serial path)', () => {
      ...
      const rung = makeRung({
        nodes: [leftRail as any, contact1 as any, parallelOpen as any, contact2 as any],
        edges: [
    ...
    it('findNodeBasedOnParallelOpen chains through another open parallel', () => {
      ...
      const rung = makeRung({
        nodes: [leftRail as any, contact1 as any, parallelOpen1 as any, parallelOpen2 as any, contact2 as any],
        edges: [
          { id: 'e1', source: 'c1', target: 'po1', sourceHandle: 'out', targetHandle: 'in' },
