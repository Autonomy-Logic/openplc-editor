  ...
  return (
    <Select value={value} onValueChange={(value) => onValueChange(value)} onOpenChange={setSelectIsOpen}>
      ...
      <SelectContent
        ...
        align='center'
        side='bottom'
        className='z-50 w-[--radix-select-trigger-width] rounded-lg border border-neutral-100 bg-white outline-none drop-shadow-lg dark:border-brand-medium-dark dark:bg-neutral-950'
      >
