...
export const AICodeBlock = ({ code, language, onInsertAtCursor }: AICodeBlockProps) => {
  ...
  return (
    <div className='group relative my-1 w-full min-w-0 max-w-full overflow-hidden rounded-md border border-neutral-200 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900'>
