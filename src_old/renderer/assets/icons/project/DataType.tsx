...
type IDataTypeIconProps = ComponentPropsWithoutRef<'svg'> & {
  size?: 'sm' | 'md' | 'lg'
}
...
export const DataTypeIcon = (props: IDataTypeIconProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <path opacity='0.4' d='M9 17.5L14 20L19 17.5' stroke='#B4D0FE' strokeLinecap='round' strokeLinejoin='round' />
      <path opacity='0.4' d='M9 15L14 17.5L19 15' stroke='#B4D0FE' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  )
}
