...
const configuration: webpack.Configuration = {
  ...
  plugins: [
    ...
    new webpack.EnvironmentPlugin({
      ...
      VPP_CATALOG_URL: '',
      // Same mechanism for the Edge WEB app (the `/buy` license page), which
      // is a different origin from the API above.  Falls back to the
      // production host hardcoded in `system-adapter.ts` when unset:
